...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-on-surface-variant">
            Every update from your courses, most recent first.
        </p>
    </div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative flex-1 min-w-[180px] max-w-xs">
                ...
                <input
                    ...
                    id="activity-search"
                    value="{{ $currentSearch }}"
                    placeholder="Search by teacher, course, or file…"
                    autocomplete="off"
            ...
            <div class="relative shrink-0">
                <select id="activity-type"
                        class="appearance-none pl-4 pr-9 py-2.5 rounded-[16px] text-sm cursor-pointer
                               ...
                               focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary
                               transition-colors">
                    @foreach(\App\Helpers\StudentActivityHelper::TYPE_LABELS as $value => $label)
    ...
    <div class="bg-surface-white border border-outline-variant/40 rounded-[20px] shadow-[0px_1px_4px_rgba(30,42,74,0.06)] overflow-hidden">
        <ul id="activity-list" class="divide-y divide-outline-variant/20">
            @include('student.activity._list', ['activities' => $activities])
        </ul>
    </div>
...
<script>
    (function () {
        ...
        const baseUrl     = '{{ route('student.activity.index') }}';
