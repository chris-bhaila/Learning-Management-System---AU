    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-10 md:px-12">
            <div class="w-full max-w-[400px] space-y-7 animate-fade-up">
                ...
                {{-- Dev-mode notice --}}
                <div class="flex items-start gap-3 px-4 py-3 rounded-[16px]
                            bg-gold/10 border border-gold/30 text-on-gold text-xs leading-relaxed">
                    <span class="material-symbols-outlined text-[16px] shrink-0 mt-0.5 text-gold">construction</span>
                    <span>
                        <strong class="font-semibold">Development mode</strong> — using email &amp; password login.
                        Google SSO will replace this in production.
                    </span>
                </div>
                ...
                {{-- Google SSO (production path) --}}
                <a href="{{ Route::has('auth.google') ? route('auth.google') : '#' }}"
                   class="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-[24px]
                          text-sm font-semibold cursor-pointer
                          bg-surface-white border border-outline-variant/60 text-on-surface
